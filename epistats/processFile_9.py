...
Description: 
    ...
    parser.add_option('-a', '--alleleFreqDiff', dest='alleleFreqDiff', default=1000000, help='maximum difference in allele frequency between subpopulations abs(totalAlleleFreq - subpopFreq) / totalAllelFreq < alleleFreqDiff  (default 1000000)')
